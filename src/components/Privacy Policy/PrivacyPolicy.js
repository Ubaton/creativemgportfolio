        ...
        <div className="container py-20 p-6 mx-auto text-gray-50">
          ...
          <div className="p-4 space-y-4 ">
            <p>
              ...
              gather, employ, reveal, and uphold the sanctity of your
              information throughout your engagement with our services.
            </p>

            <p>
              In the course of facilitating our services, we intentionally
              curate only the essential personal information, thereby adhering
              to the principle of minimalism. This data encapsulates fundamental
              user particulars and usage insights, which in turn aids us in
              refining the quality of our services. Be assured that our data
              collection practices are judicious and calculated, designed solely
              to enhance your experience.
            </p>

            <p>
              It is our unwavering commitment to adopt security protocols that
              are in tandem with industry norms. These protocols are
              meticulously woven into our operational framework to act as an
            ...
            <p>
              As you engage with our services, your implicit consent to the
              terms enshrined in this Privacy Policy is understood. By
              continuing to avail our services, you acknowledge and consent to
              the assortment and utilization of information in accordance with
              the tenets outlined herein.
            </p>

            <p>
              Your trust remains the cornerstone of our endeavors. We remain
              steadfast in our commitment to protecting your privacy,
              recognizing it as an indispensable facet of your interaction with
